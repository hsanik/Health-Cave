    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (roleUpdateResult) {
                ...
                if (roleUpdateResult.currentRole && roleUpdateResult.currentRole !== 'user') {
                    console.log(`User already has role: ${roleUpdateResult.currentRole}, no role change needed`);
                }
            }
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div className="pt-6">
                            ...
                            >
                                ...
                                {submitting ? "Processing..." : "Book Appointment & Proceed to Payment"}
                            </button>
                        </div>
                    </form>
                </div>
